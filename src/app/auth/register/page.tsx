...
import { CalendarPlus, LineChart, Users } from "lucide-react";
import { RegisterForm } from "@/components/auth/register-form";

export const metadata: Metadata = {
  title: "สมัครสมาชิก — EVENTRA",
  description: "สมัครสมาชิก EVENTRA เพื่อค้นหา สร้าง และจัดการอีเวนต์ของคุณ",
};

const highlights = [
  { icon: CalendarPlus, text: "สร้างอีเวนต์และเปิดขายบัตรได้ในไม่กี่นาที" },
  { icon: Users, text: "จัดการผู้เข้าร่วมและเช็คอินแบบเรียลไทม์" },
  { icon: LineChart, text: "ดูยอดขายและวิเคราะห์ผลงานอีเวนต์ของคุณ" },
];
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-600 p-10 text-white lg:flex">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-3xl font-bold tracking-tight text-balance">
            เริ่มต้นสร้างอีเวนต์ของคุณวันนี้
          </h2>
          <p className="mt-3 text-indigo-100">
            สมัครสมาชิกฟรี ไม่ว่าคุณจะเป็นผู้เข้าร่วมงานหรือผู้จัดงาน
            EVENTRA พร้อมให้บริการครบวงจร
          </p>
      ...
      <div className="flex flex-col justify-center px-4 py-12 sm:px-6 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            สมัครสมาชิกฟรี เริ่มค้นหาและสร้างอีเวนต์ของคุณ
          </p>
